...
import it.tss.aste.business.entity.Offerta;
import it.tss.aste.presentation.util.JsfUtil;
import it.tss.aste.presentation.util.JsfUtil.PersistAction;
import it.tss.aste.business.boundary.OffertaFacade;
...
public class OffertaController implements Serializable {
    ...
    @EJB
    private it.tss.aste.business.boundary.OffertaFacade ejbFacade;
